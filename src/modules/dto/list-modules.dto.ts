...
export class ListModulesDto {
  ...
  @ApiPropertyOptional({ example: 'dashboard', description: 'Search by module name, alias, or ID' })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({ example: 'module_name', enum: ['module_name', 'created_at', 'updated_at'], default: 'created_at' })
  @IsOptional()
