...
export const SITEMAP_FREQUENCIES = ['always', 'hourly', 'daily', 'weekly', 'monthly', 'yearly', 'never'] as const;
...
export class CreateSeoDto {
  ...
  @ApiPropertyOptional({ example: 'dubai, tours, travel, sightseeing', description: 'Comma-separated keywords' })
  @IsOptional()
  @IsString()
  keywords?: string;

  @ApiPropertyOptional({ example: 'https://example.com/tours/dubai', description: 'Canonical URL' })
  @IsOptional()
  ...
  @ApiProperty({ example: 'uuid-of-item', description: 'Item UUID within the selected module' })
